...
namespace Projeto_Maromba_Test
{
    public static class Calculos
    {
        ...
        public static int Idadele(string Data)
        {
            //Pega o ano do 0-5(XX/XX/) 6-9(XXXX)
            string ano = Data[6].ToString() + Data[7].ToString() + Data[8].ToString() + Data[9].ToString();
            //Diminui o ano atual pelo da Data
            int Idade = DateTime.Today.Year - int.Parse(ano);
            return Idade;
        }
